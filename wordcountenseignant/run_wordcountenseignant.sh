...
HDFS_OUTPUT="/output"
JAR_NAME="wc.jar"
MAIN_CLASS="wordcountenseignant.WCDriver"

echo "🚀 Déploiement wordcountenseignant Hadoop..."

# 1) Copie du code Java dans le container
echo "📁 Copie du dossier wordcountenseignant vers le conteneur..."
...
docker exec -it $CONTAINER bash -c "
    cd $REMOTE_WC_DIR &&
    javac -cp \"\$(hadoop classpath)\" -d . wordcountenseignant/*.java
"
...
docker exec -it $CONTAINER bash -c "
    cd $REMOTE_WC_DIR &&
    jar -cvf $JAR_NAME wordcountenseignant
"
